...
//Last modified: Sun, Dec 02, 2012 10:10:58 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.6474075223142446 9.6141285849152993 -16.748681227567182 ;
	setAttr ".r" -type "double3" 155.39999999998409 -35.999999999999929 179.99999999999761 ;
	setAttr ".rp" -type "double3" 0 0 1.7763568394002505e-15 ;
	setAttr ".rpt" -type "double3" 5.7737368316653055e-16 2.8439519627288715e-15 -3.0421716083235234e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 22.769122710450773;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 5.5212216827556331 0.13578014392912052 7.2117892768730485e-09 ;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.2086219389319837 -0.78070794464909787 100.58094854085329 ;
	setAttr ".rp" -type "double3" -3.1554436208840493e-30 0 0 ;
	setAttr ".rpt" -type "double3" 1.4210854715202007e-14 0 -1.4390475280977722e-14 ;
...
createNode transform -n "pPipe1";
	setAttr ".t" -type "double3" 7.3431342732590066 0.0011284091510712635 -1.5350588092976141 ;
...
createNode transform -n "pPipe2";
	setAttr ".t" -type "double3" 5.4651961587356102 -0.72897500127090165 -1.3385121679687577 ;
	setAttr ".r" -type "double3" -90 0 0 ;
...
createNode transform -n "pPipe3" -p "group2";
	setAttr ".t" -type "double3" 9.0973924522023317 -0.72897500127090165 -1.3385121679687577 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode transform -n "pPipe4" -p "group2";
	setAttr ".t" -type "double3" 7.9021116835950478 -0.72897500127090165 -1.3385121679687577 ;
...
createNode transform -n "pPipe5" -p "group4";
	setAttr ".t" -type "double3" 7.3431342732590066 0.0011284091510712635 -1.9969079352232064 ;
	setAttr ".r" -type "double3" -90 0 0 ;
...
createNode polyBevel -n "polyBevel1";
	...
	setAttr ".ix" -type "matrix" 1 0 -0 0 -0 2.2204460492503131e-16 -1 0 0 1 2.2204460492503131e-16 0
		 7.3431342732590066 0.0011284091510712635 -1.5350588092976141 1;
	setAttr ".ws" yes;
	setAttr ".oaf" yes;
	setAttr ".o" 0.5;
	setAttr ".at" 180;
...
createNode polyCylProj -n "polyCylProj1";
	...
	setAttr ".ps" -type "double2" 180 2.1156097054481506 ;
...
connectAttr "blinn9SG.mwc" "polySurfaceShape1.iog.og[0].gco";
connectAttr "polyTweakUV1.uvtk[0]" "polySurfaceShape1.uvst[3].uvtw";
connectAttr "groupParts3.og" "polySurfaceShape2.i";
connectAttr "groupId4.id" "polySurfaceShape2.iog.og[0].gid";
connectAttr "blinn9SG.mwc" "polySurfaceShape2.iog.og[0].gco";
...
connectAttr "polyBevel1.out" "pPipeShape1.i";
...
connectAttr "polySurfaceShape1.iog.og[0]" "blinn9SG.dsm" -na;
connectAttr "polySurfaceShape2.iog.og[0]" "blinn9SG.dsm" -na;
